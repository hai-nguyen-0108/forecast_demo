...
void dataLabelTapEvent(dynamic chart, DataLabelSettings dataLabelSettings,
  ...
  datalabelArgs = DataLabelTapDetails(
      seriesIndex,
      pointIndex,
      chart is SfCartesianChart ? point.label : point.centerImage,
      dataLabelSettings,
...
EdgeInsetsGeometry getEffectiveLegendMargin(
  ...
  final bool needPadding = chart is SfCircularChart || chart is SfPyramidChart;
...
Widget renderChartTitle(StateProperties stateProperties) {
  ...
  if (widget.title.centerImage != null &&
      widget.title.centerImage.isNotEmpty == true) {
    ...
    titleWidget = Container(
      ...
      child: Container(
          ...
          child: Text(widget.title.centerImage,
              style: TextStyle(
                  color: color,
                  fontSize: fontSize,
                  fontFamily: fontFamily,
